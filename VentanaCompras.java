...
public class VentanaCompras extends JFrame{
	...
	public void crearPanel(Producto p, JPanel pCentro) {
		...
		JButton darMegusta = new JButton("Favorito"); 
		...
		darMegusta.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				try {
					VentanaCompras.this.darMegusta(VentanaCompras.this.prod.getId(),VentanaCompras.this.prod.getNombre());
					pCentro.removeAll();
					VentanaCompras.this.productos=getProductos();
					pCentro.revalidate();
